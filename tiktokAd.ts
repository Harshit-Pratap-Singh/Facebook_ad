...
const previewAd = async (acccess_token, advertiser_id, ad_id) => {
  try{
    const response = await axios.post(
    "https://sandbox-ads.tiktok.com/open_api/v1.2/creative/ads_preview/create/",
    {
      advertiser_id,
      material_type: "AD",
      ad_id,
